...
def rmse(org_img: np.ndarray, pred_img: np.ndarray, max_p=1) -> float:
    """
...
def psnr(org_img: np.ndarray, pred_img: np.ndarray, max_p=1) -> float:
    """
...
def ssim(org_img: np.ndarray, pred_img: np.ndarray, max_p=1) -> float:
    """
